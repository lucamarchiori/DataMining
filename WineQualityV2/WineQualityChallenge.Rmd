...
### Random forest
```{r}
rForestfit <- randomForest(quality ~ alcohol + volatile.acidity + citric.acid + density + pH + sulphates, train)
yhat = predict(rForestfit, newdata=test)
write.table(file="fitRandomForest", yhat, row.names = FALSE, col.names = FALSE)
```
